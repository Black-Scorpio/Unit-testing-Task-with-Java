...
class ElectronicProductTest {
    ...
    void setUp() {
        ...
        eProduct = new ElectronicProduct(1004,"hair dryer",dyson, 99.99,10,120,false);
    }
    ...
    void setConstructorTests(){
        Assertions.assertThrows(IllegalArgumentException.class, ()->{new ElectronicProduct(1004,"hair dryer",dyson, 99.99,10,110,false);});
        Assertions.assertThrows(IllegalArgumentException.class, ()->{new ElectronicProduct(1004,"hair dryer",dyson, 99.99,10,150,false);});
        Assertions.assertThrows(IllegalArgumentException.class, ()->{new ElectronicProduct(1004,"hair dryer",dyson, 99.99,10,180,false);});
    }
}